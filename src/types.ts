...
// Tissue Identity
export const TISSUE_ID = 'TIS-POLICY-v0.1.0' as const;
export const TISSUE_HASH = '12859ff4' as const;
export const CLASSIFICATION = 'Structural Boundary' as const;
export const COMPOSED_CELLS = ['CEL-POLICYEVAL', 'CEL-POLICYSTORE', 'CEL-AUDITLOG'] as const;
